...
class Ui(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        uic.loadUi('Project_Rana\Javelin_Throw_Simulation\project_ui.ui', self)
        # Load the image
        self.img = mpimg.imread(r'Project_Rana\Javelin_Throw_Simulation\Images\area.png')
    ...
    def draw_frame(self):
        ...
        if len(self.x_vals) > 1:
            self.ax.plot(self.x_vals, self.y_vals, color='blue', linewidth=3)
